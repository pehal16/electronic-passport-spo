...
- модуль формирования ведомостей (заполнение → предпросмотр → печать)
...
1. Открыть дисциплину в учебном плане / журнале / оценках.
2. Нажать `Сформировать ведомость`.
3. При необходимости нажать `Заполнить из журнала`.
4. Проверить оценки и статусы студентов.
5. Перейти на вкладку `Предпросмотр` и нажать `Печать`.

Поддерживаются типы:

- ведомость дифференцированного зачета
- зачетная ведомость
- ведомость комплексного дифференцированного зачета
- ведомость комплексного экзамена
